...
compute_cor_phylosig_time_comp.fac <- function(list_sim) {
  ...
  for (sim in 1:length(list_sim)) {
    ...
    #############
    # Compute svd to get low dimension (d = 6) distance matrices
    #############
    ...
    list_interact_distances_prey_corrected_d4 <- list()
    ...
    if(length(vec_timesteps_all0) > 0){
      ...
      list_interact_distances_pred_corrected_d4 <- list_interact_distances_pred_corrected_d4[-(1:n_discard_timesteps_all0)]
      
      list_interact_distances_prey_corrected_d4 <- list_interact_distances_prey_corrected_d4[-(1:n_discard_timesteps_all0)]
      
      list_interact_distances_mean_corrected_d4 <- list_interact_distances_mean_corrected_d4[-(1:n_discard_timesteps_all0)]
      
      list_dist.phylo_pres_d4 <- list_dist.phylo_pres_d4[-(1:n_discard_timesteps_all0)]
    ...
    for (i in 1:length(list_dist.phylo_pres_d4)) {
      
      list_dist_dist.phylo_pres[[i]] <- as.dist(list_dist.phylo_pres_d4[[i]])
      list_dist_interact_distances_pred_corrected[[i]] <- as.dist(list_interact_distances_pred_corrected_d4[[i]])
      list_dist_interact_distances_prey_corrected[[i]] <- as.dist(list_interact_distances_prey_corrected_d4[[i]])
      list_dist_interact_distances_mean_corrected[[i]] <- as.dist(list_interact_distances_mean_corrected_d4[[i]])
