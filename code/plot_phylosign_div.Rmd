...
df_div_list_fw <- readRDS(here::here("output/foodweb/df_div_list_fw_100sim.rds"))
```
...
df_signal_time_fw <- readRDS(here::here("output/foodweb/df_signal_time_fw_100sim.rds"))
